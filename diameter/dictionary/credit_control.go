...
var CreditControlDictionary = `<?xml version="1.0" encoding="UTF-8"?>
<diameter>
	...
	<application id="4">
		...
		<command code="272" short="CC" name="Credit-Control">
			<request>
				...
				<rule avp="Subscriber-IN" required="false" max="1"/>
			</request>
			<answer>
		...
		<avp name="Subscriber-IN" code="22168" must="-" may="P,M" must-not="V" may-encrypt="Y">
			<data type="Integer32"/>
		</avp>
